...
/*
 * $Id: mtwist.h,v 1.12 2002/10/30 07:39:54 geoff Exp $
 *
 ...
 */
MT_EXTERN inline unsigned long mts_lrand(
 ...
 */
MT_EXTERN inline MT_ALWAYS_INLINE unsigned long long mts_llrand(
    register mt_state*	state)		/* State for the PRNG */
    {
    register unsigned long
 ...
 */
MT_EXTERN inline MT_ALWAYS_INLINE double mts_drand(
    register mt_state*	state)		/* State for the PRNG */
    {
    register unsigned long
			random_value;	/* Pseudorandom value generated */
 ...
 */
MT_EXTERN inline MT_ALWAYS_INLINE double mts_ldrand(
    register mt_state*	state)		/* State for the PRNG */
    {
 ...
 */
MT_EXTERN inline unsigned long mt_lrand()
    {
    register unsigned long
			random_value;	/* Pseudorandom value generated */
 ...
 */
MT_EXTERN inline MT_ALWAYS_INLINE unsigned long long mt_llrand()
    {
    register unsigned long
			random_value_1;	/* 1st pseudorandom value generated */
    register unsigned long
 ...
 */
MT_EXTERN inline MT_ALWAYS_INLINE double mt_drand()
    {
    register unsigned long
			random_value;	/* Pseudorandom value generated */
 ...
 * mts_drand for more speed but less precision.
 */
MT_EXTERN inline MT_ALWAYS_INLINE double mt_ldrand(void)
    {
#if MT_MACHINE_BITS == 64
    unsigned long long	final_value;	/* Final (integer) value */
#endif /* MT_MACHINE_BITS */
...
class mt_prng
	...
	friend ostream&	operator<<(ostream& stream, const mt_prng& rng);
	friend istream&	operator>>(istream& stream, mt_prng& rng);
...
inline ostream& operator<<(
    ostream&		stream,		// Stream to save to
...
inline istream& operator>>(
    istream&		stream,		// Stream to laod from
